...
public class Favourites_FragmentImage2 extends Fragment
{
    int position;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.favourites_favouriteimage2,container,false);
        ImageView imageView= (ImageView) view.findViewById(R.id.favourites_image2);
